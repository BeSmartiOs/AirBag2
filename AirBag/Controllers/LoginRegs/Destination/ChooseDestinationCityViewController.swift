...
protocol ClassDestinationCity: class {
    func ChooseDestinationCity(_ city: String?, _ id : Int?)
}

class ChooseDestinationCityViewController: UIViewController,UITableViewDataSource,UITableViewDelegate  {
    ...
    weak var delegate: ClassDestinationCity?
    var currentCountry = ""
    var arr = ["ffff","aaaaa"]
    ...
    override func viewWillAppear(_ animated: Bool) {
         self.getCities(id: self.choosenDestinationCountryId!)
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.delegate?.ChooseDestinationCity(self.cityResp?[indexPath.row].name, self.cityResp?[indexPath.row].id)
    }
